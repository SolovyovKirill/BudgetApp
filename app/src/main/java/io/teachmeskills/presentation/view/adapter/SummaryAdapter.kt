...
class SummaryAdapter : ListAdapter<CurrencySummaryItemModel, CurrencySummaryItemHolder>(DiffCallback()) {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CurrencySummaryItemHolder {
        val inflate = LayoutInflater.from(parent.context)
        val itemView =  inflate.inflate(R.layout.item_currency_summary, parent, false)
